...
public class DataEntity_v26_1_R2 implements DataEntity {
    ...
    public DataEntity_v26_1_R2(Entity entity) {
        readEntityData(entity);
    }

    public DataEntity_v26_1_R2(HashMap<String, Object> data) {
        this.data.putAll(data);
    }

    public DataEntity_v26_1_R2() {
    }
